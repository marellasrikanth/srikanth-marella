...
/****** Object:  Database [B2B]    Script Date: 7/12/2017 11:36:38 PM ******/
CREATE DATABASE [B2B]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'B2B', FILENAME = N'C:\Users\srikantm.STAR\B2B.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'B2B_log', FILENAME = N'C:\Users\srikantm.STAR\B2B_log.ldf' , SIZE = 1536KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [B2B] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [B2B] SET RECOVERY FULL 
GO
...
ALTER DATABASE [B2B] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
